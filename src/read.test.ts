...
const testCases: TestCase[] = [
  ...
  },
  {
    ...
    expectedOutputContains: [
      ...
      'Inverted list offset: 28244123',
    ],
  },
  {
    name: 'Term and document info test (positive case)',
    args: ['--term', 'health', '--doc', 'clueweb12-0000tw-13-04988'],
    expectedOutputContains: [
      'Inverted list for term: health',
      'In document: clueweb12-0000tw-13-04988',
      'TERMID: 10',
      'DOCID: 2',
      'Term frequency in document: 6',
      'Positions: 3, 22, 57, 197, 211, 247',
    ],
  },
  {
